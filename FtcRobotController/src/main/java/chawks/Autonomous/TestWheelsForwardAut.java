...
public class TestWheelsForwardAut extends OpMode {
    ...
    public TestWheelsForwardAut(int leftFrontTarget, int leftBackTarget, int rightFrontTarget, int rightBackTarget) {
    ...
    public TestWheelsForwardAut(int leftFrontTarget, int leftBackTarget, int rightFrontTarget, int rightBackTarget, double strafeFactor) {
        int encoderCpr = robot.getWheelConfiguration().getCountsPerMotorRev();
